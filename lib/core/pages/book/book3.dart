...
class ImageViewerPage3 extends StatefulWidget {
  final String title;
  final int initialImageIndex;

  const ImageViewerPage3(this.title, this.initialImageIndex, {super.key});

  @override
  _ImageViewerPageState3 createState() => _ImageViewerPageState3();
}

class _ImageViewerPageState3 extends State<ImageViewerPage3>
...
class ImageViewerCarousel3 extends StatefulWidget {
  final int initialImageIndex;
  final bool showControls;
  final AnimationController controlsAnimation;
  final Function(int) onPageChanged;

  const ImageViewerCarousel3(
  ...
  @override
  _ImageViewerCarouselState3 createState() => _ImageViewerCarouselState3();
}

class _ImageViewerCarouselState3 extends State<ImageViewerCarousel3>
        ...
        await assetsAudioPlayer
            .open(
              Audio.network(
                cdnUrl,
                metas: Metas(
                  title: 'Size Sözüm - Sayfa $imageNumber',
                  artist: 'Size Sözüm Öz',
                ),
              ),
              autoStart: true,
              showNotification: true,
  ...
  Future<String> _getImagePath(String fileName, {bool isSevgi = false}) async {
    try {
      final appDir = await getApplicationDocumentsDirectory();
      ...
      print('❌ Local yok, CDN kullanılıyor: $remoteUrl');
      return remoteUrl;
    } catch (e) {
...
// ContentPage3 kısmı değişmedi - aynı kalıyor
class ContentPage3 extends StatefulWidget {
  const ContentPage3({Key? key}) : super(key: key);

  @override
  _ContentPageState3 createState() => _ContentPageState3();
}

class _ContentPageState3 extends State<ContentPage3>
    with SingleTickerProviderStateMixin {
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  'Size Sözüm Öz İnci Armağan Sesli Kitap',
                  style: TextStyle(
                    fontSize: 16,
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            ImageViewerPage3(item['text'], item['extraCount']),
                      ),
                    );
                  },
                  child: Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ImageViewerPage3(
                      'Size Sözüm Öz İnci Armağan - Sayfa $imageNumber',
                      index,
                    ),
                  ),
                );
